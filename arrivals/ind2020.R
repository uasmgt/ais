...
save(ind2020, file = "~/data/data_ind_2020.rda")
write.csv2(ind2020, file = "~/data/data_ind_2020.csv", row.names = FALSE)

# Очистка окружения
rm(list = setdiff(ls(), "ind2020"))
