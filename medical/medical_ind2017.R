...
data.arrivals <- get(load("~/data/data_ind_2017.rda"))
...
medical.data <- lapply(file.list, GetMedical2018)
...
# Сохранение данных
medical.data -> medical.ind2017
save(medical.ind2017, file = "~/data/medical_ind2017.rda")
write.csv2(medical.ind2017, file = "~/data/medical_ind2017.csv",
           row.names = FALSE)

# Очистка окружения ----------------------------------------------------
rm(list = setdiff(ls(), "medical.ind2017"))
