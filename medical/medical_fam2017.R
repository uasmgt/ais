...
# Сохранение данных
medical.data -> medical.fam2017
save(medical.fam2017, file = "~/data/medical_fam2017.rda")
write.csv2(medical.fam2017, file = "~/data/medical_fam2017.csv",
           row.names = FALSE)

# Очистка окружения ----------------------------------------------------
rm(list = setdiff(ls(), "medical.fam2017"))