...
data.arrivals <- get(load("~/data/data_fam_2018.rda"))
...
# Сохранение данных
medical.data -> medical.fam2018
save(medical.fam2018, file = "~/data/medical_fam2018.rda")
write.csv2(medical.fam2018, file = "~/data/medical_fam2018.csv",
           row.names = FALSE)

# Очистка окружения ----------------------------------------------------
rm(list = setdiff(ls(), "medical.fam2018"))