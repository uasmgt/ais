...
# Реестр отказов 
denials.data <- read.csv2("~/data/denials_dep2020.csv", encoding = "UTF-8")
# Данные о лагерях
...
# Сохранение данных ----------------------------------------------------
# dep2020 <- dataset[c(1:22, 45, 46)]
# med.dep2020 <- dataset[c(1:6, 13, 16, 23:44, 47:55)]
data.dep2020 <- dataset

# для анализа в R
save(data.dep2020, file = "~/data/data_dep2020.rda")
# для анализа в Excel
write.csv2(data.dep2020, file = "~/data/data_dep2020.csv")
